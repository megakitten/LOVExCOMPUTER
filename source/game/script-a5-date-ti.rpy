...
label ti_question:
    ...
    ti "But people write such awful stuff! I found this manual for how to use computers, and I just cant believe someone would write this!"

    ### Show a couple pages from MY COMPUTER LIKES ME WHEN

    you "This manual is 30 years old. All that thinking is in the past!"
    ti "..."
    ti "I'm not so sure about that about that..."
